...
//Check if the view is unique for a specific visitor and page
...
function add_view($conn, $visitor_ip, $page_id, $page_name)
{
	//Comment this if() to record all views, whether unique or not
	if(is_unique_view($conn, $visitor_ip, $page_id) === true) 
	{
		...
		//DEBUG  try to print IP address:
		echo "Your ip address recorded as: ", $visitor_ip, "<br>";
		//echo "page id: ", $page_id, "<br>";
		$query = "INSERT INTO page_views (visitor_ip, page_id, page_name) VALUES ('$visitor_ip', '$page_id', '$page_name')";
